  ...
  return (
    <article className="flex items-center justify-center flex-col max-w-7xl mx-auto mt-14 px-6 rounded-2xl">
      <div className="font-bold text-center mb-4">
        <h1 className="text-3xl md:text-5xl max-w-full mx-auto px-4">
      ...
      <div className="flex justify-center space-x-4 mb-6 bg-transparent p-2 rounded-md border border-green">
      ...
      <div className="flex items-center justify-between bg-white p-2 sm:p-2 w-full rounded-lg shadow">
