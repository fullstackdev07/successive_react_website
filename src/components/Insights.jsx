...
const Insights = () => {
  ...
  return (
    <article className="flex items-center justify-center flex-col max-w-7xl mx-auto mt-20 px-4 bg-green rounded-2xl">
      <div className="flex flex-wrap items-center justify-center gap-4 px-6 py-1 mt-4 backdrop-blur-sm bg-white/30 rounded-2xl">
      ...
      <div className="flex flex-col md:flex-row mt-10 p-6 rounded-lg">
        ...
        <div className="md:w-1/2 w-full text-white px-6 md:px-12">
          ...
          <ul className="mt-6 space-y-4 text-lightgreen">
