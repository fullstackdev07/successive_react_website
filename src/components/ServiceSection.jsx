  ...
  return (
    <div className="mt-2 mx-4" id="About">
      ...
      <div className="flex flex-col items-center justify-center max-w-7xl mx-auto py-8 space-y-6 text-center mt-[-1rem]">
        <h1
          className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 leading-tight max-w-3xl  mt-1"
          data-aos="fade-left"
        >
          {callToAction.title}
        </h1>
        <a href={callToAction.href}>
          <button
            ...
            px-6 py-2 md:px-4 md:py-2 rounded-lg shadow-lg bg-green"
          >
