...
const ServiceSection = () => {
    ...
    return (
        <div className="mx-4">
            <article
                className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-4 bg-mediumgreen rounded-xl shadow-lg p-6 space-y-6 md:space-y-0 md:gap-8"
                data-aos="fade-left"
            >
                ...
                <div className="md:w-1/2 ">
                    <h1 className="text-3xl mt-[-4rem] md:text-5xl max-w-lg font-bold text-left text-gray-800 
                    ">
                        {sectionTitle.main}{" "}
            ...
            <div className="flex items-center justify-center flex-col max-w-7xl mx-auto mt-10 px-4 rounded-xl p-6 space-y-8 text-center">
                <div>
                    <h1 className="text-3xl md:text-5xl max-w-2xl text-gray-800">
                        {callToAction.title}
                    </h1>
                </div>
                <div>
